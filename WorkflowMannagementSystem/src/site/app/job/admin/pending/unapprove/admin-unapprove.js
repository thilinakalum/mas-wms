(function () {
    angular.module("AppModule")
            .controller("AdminUnapproveController", function ($scope, $location, $rootScope, Notification, Factory) {
                $scope.model = {};
                $scope.ui = {};
                $scope.model.job = {};
                ...
                var findAllUrl = "/api/wms/job/get-all-jobs-by-admin-and-status/" + 'UNAPPROVE';
